...
import { Card, CardHeader } from "@/components/logdeck-demo/ui/card";
import { Spinner } from "@/components/logdeck-demo/ui/spinner";
import type { AggregateLogTarget } from "@/components/logdeck-demo/api/get-aggregated-logs";
import {
  getAggregatedLogs,
  streamAggregatedLogs,
} from "@/components/logdeck-demo/api/get-aggregated-logs";
import type {
...
import { useContainerLogStream } from "@/components/logdeck-demo/hooks/use-container-log-stream";
import { useDebouncedValue } from "@/components/logdeck-demo/hooks/use-debounced-value";
import { useHistoryLogs } from "@/components/logdeck-demo/hooks/use-history-logs";
import { useHistoryStatus } from "@/components/logdeck-demo/hooks/use-history-status";
...
export function LogViewer({
  ...
  // Row indices shift when the filters change, so drop selection and expanded rows.
  useEffect(() => {
    clearSelection();
